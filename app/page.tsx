...
export default function HomePage() {
  ...
  const trustItems = [
    { text: 'Serving Lumberton Families for Over a Decade', icon: trustIcons[0] },
    { text: 'Rated 5 Stars by Robeson County Patients', icon: trustIcons[1] },
    { text: 'Modern Technology in a Comfortable, Judgment-Free Office', icon: trustIcons[2] },
    { text: 'Same-Day Emergency Appointments Available', icon: trustIcons[3] },
  ];

  const services = [
    { title: 'Family & General Dentistry', desc: 'From first teeth to golden years, Dr. Walker provides comprehensive dental care for every member of your Lumberton family. Routine cleanings, exams, and preventive treatments tailored to keep your smile healthy for life.', icon: serviceIcons[0] },
    { title: 'Cosmetic Smile Makeovers', desc: 'Teeth whitening, porcelain veneers, and bonding designed to give you a confident, camera-ready smile. Walk into any room in Robeson County knowing your smile speaks for itself.', icon: serviceIcons[1] },
    { title: 'Emergency Dental Care', desc: 'A cracked tooth or sudden toothache can\'t wait. Dr. Walker offers prompt emergency appointments so Lumberton residents get relief fast, not a runaround.', icon: serviceIcons[2] },
    { title: 'Dental Implants & Restorations', desc: 'Missing teeth affect more than your smile -- they change how you eat, speak, and feel. Dr. Walker places and restores implants, crowns, and bridges that look and function like natural teeth.', icon: serviceIcons[3] },
    { title: 'Pediatric Dentistry', desc: 'A positive dental experience early on sets kids up for a lifetime of healthy habits. Dr. Walker\'s gentle approach keeps Lumberton\'s youngest patients comfortable and cavity-free.', icon: serviceIcons[4] },
    { title: 'Invisalign & Orthodontics', desc: 'Straighter teeth without metal brackets. Dr. Walker offers Invisalign clear aligners for teens and adults who want results without disrupting their daily routine.', icon: serviceIcons[5] },
  ];
  ...
  return (
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-logo">{'Dr. Sarah D. Walker, DDS'}</div>
        <a
          href="tel:19107388444"
          className="nav-cta"
          aria-label="Call Dr. Sarah D. Walker, DDS at +1 910-738-8444"
        >
          <span
      ...
      {/* HERO */}
      <section className="hero" aria-label="Welcome to Dr. Sarah D. Walker, DDS">
        ...
        <div className="hero-content">
          ...
          <p>
            Welcome to {'Dr. Sarah D. Walker, DDS'} — where modern dental technology meets compassionate
      ...
      <section className="about" aria-label="About our practice">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay={2}>
            <h2>About {'Dr. Sarah D. Walker, DDS'}</h2>
            <p>{'Dr. Sarah D. Walker, DDS has built her practice on a simple belief: every person in Lumberton deserves dental care that feels personal, not transactional. Her office blends modern techniques with genuine Southern warmth, creating an experience where patients actually look forward to their next visit. Whether you\'re a longtime Robeson County resident or new to the area, Dr. Walker and her team are ready to become your trusted dental home.'}</p>
      ...
      <section className="cta-section" aria-label="Contact us">
        <div className="cta-card" data-animate>
          <h2>Contact {'Dr. Sarah D. Walker, DDS'}</h2>
          <p>
          ...
          <a
            ...
            aria-label="Call Dr. Sarah D. Walker, DDS to schedule an appointment"
          >
            <span
              dangerouslySetInnerHTML={{ __html: phoneIcon }}
              aria-hidden="true"
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-brand-name">{'Dr. Sarah D. Walker, DDS'}</div>
            <p>
          ...
          <div className="footer-contact">
            ...
            <div className="footer-contact-item">
              ...
              <a
                href="tel:19107388444"
                aria-label="Call Dr. Sarah D. Walker, DDS"
        ...
        <div className="footer-bottom">
          &copy; {new Date().getFullYear()} {'Dr. Sarah D. Walker, DDS'}. All rights
          reserved.
        </div>
      </footer>
    </>
